...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeFourFiveThreeTwoSixEightSevenValue,
    setTextFieldThreeFourFiveThreeTwoSixEightSevenValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveThreeTwoSevenZeroOneValue,
    setTextFieldThreeFourFiveThreeTwoSevenZeroOneValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveThreeTwoSixNineFourValue,
    setTextFieldThreeFourFiveThreeTwoSixNineFourValue,
  ] = useStateMutationAction("");
  const buttonTwoNineSevenSixSixNineTwoSixOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeFourFiveThreeTwoSixEightSevenValue,
      image: textFieldThreeFourFiveThreeTwoSevenZeroOneValue,
      color: textFieldThreeFourFiveThreeTwoSixNineFourValue,
    },
    model: Pet,
    schema: schema,
  });
  const buttonThreeFourFiveThreeTwoSevenOneSixOnClick =
    useDataStoreUpdateAction({
      fields: {
        name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
        age: textFieldTwoNineSevenSixSixNineTwoThreeValue,
      ...
      >
        ...
        >
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveThreeTwoSixEightSevenValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveThreeTwoSixEightSevenValue(
                event.target.value
              );
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveThreeTwoSixNineFourValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveThreeTwoSixNineFourValue(
                event.target.value
              );
          ...
          <TextField
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveThreeTwoSevenZeroOneValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveThreeTwoSevenZeroOneValue(
                event.target.value
              );
        ...
        >
          ...
          <Button
            ...
            children="Update"
            onClick={() => {
              buttonThreeFourFiveThreeTwoSevenOneSixOnClick();
            }}
